...
import { ArrowLeftIcon, UserIcon, EnvelopeIcon, LockClosedIcon, EyeIcon, EyeSlashIcon } from "@heroicons/react/24/outline";
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-3">
              <label className="block text-sm sm:text-base text-white/90">
                {content.auth.signUp.usernameLabel}
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder={content.auth.signUp.usernamePlaceholder}
            ...
            <div className="space-y-3">
              <label className="block text-sm sm:text-base text-white/90">
                {content.auth.signUp.emailLabel}
              </label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-white/50">
            ...
            >
              {content.auth.signUp.continueButton}
            </button>
          </form>
          ...
          <div className="space-y-3">
            ...
            >
              ...
              {content.auth.signUp.continueWithApple}
            </button>
            ...
            >
              ...
              {content.auth.signUp.continueWithGoogle}
            </button>
          </div>
